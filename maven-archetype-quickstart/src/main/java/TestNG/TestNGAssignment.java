...
public class TestNGAssignment {
	...
	public void validateSearchArvind() {
		...
		driver.findElement(By.id("menu_admin_viewAdminModule")).click();
		driver.findElement(By.id("menu_admin_UserManagement")).click();
		driver.findElement(By.id("searchSystemUser_userName")).sendKeys("Arvind");
		driver.findElement(By.id("searchBtn")).click();
		boolean SearchArvind= driver.findElement(By.id("searchSystemUser_userName")).isDisplayed();
		Assert.assertTrue(SearchArvind);
